...
function UserLogin() {
  ...
  return (
    <div className="container meme-user-login-page">
      <div className="row">
        <div className="col-lg-6 mx-auto">
          <figure className="m-0">
            {/* SVG START */}
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 716.1 451.4" style={{"enable-background":"new 0 0 716.1 451.4"}} xmlSpace="preserve">
              ...
              <g id="Layer_2">
                <g>
                  <g>
                    <g>
                      <path className="st0" d="M439,428.5H332.1c-14.8,0-27.3-12.1-27-27c0.2-14.4,12-26,26.5-26h59.7c15.5,0,28.5-12.2,28.9-27.7
                ...
                c-11.9,0-21.9,9.3-22.2,21.1c-0.4,12.3,9.5,22.4,21.8,22.4h107.3c1.3,0,2.4,1,2.5,2.2C441.4,427.4,440.4,428.5,439,428.5z" />
                      ...
                      <path className="st1" d="M445.5,437.7h12v-24.1h-12c-6.7,0-12,5.4-12,12l0,0C433.5,432.3,438.9,437.7,445.5,437.7z" />
                      <g>
                        <path className="st2" d="M469.5,422.4h-5.6c-1.3,0-2.3-1-2.3-2.3l0,0c0-1.3,1-2.3,2.3-2.3h5.6c1.3,0,2.3,1,2.3,2.3l0,0
                  C471.8,421.4,470.7,422.4,469.5,422.4z" />
                        <path className="st2" d="M469.5,433.5h-5.6c-1.3,0-2.3-1-2.3-2.3l0,0c0-1.3,1-2.3,2.3-2.3h5.6c1.3,0,2.3,1,2.3,2.3l0,0
                ...
                c0-5.2,4.2-9.4,9.4-9.4h120.3c5.2,0,9.4,4.2,9.4,9.4V167.3z" />
                      <circle className="st6" cx="31.1" cy="120.8" r="5.6" />
                      <circle className="st7" cx="47.6" cy="120.8" r="5.6" />
                      <circle className="st8" cx="64.2" cy="120.8" r="5.6" />
                      <ellipse transform="matrix(0.1602 -0.9871 0.9871 0.1602 99.5971 358.7539)" className="st7" cx="260.6" cy="120.8" rx="12.5" ry="12.5" />
                      <path className="st7" d="M240,125.3h-51.7c-1.5,0-2.8-1.2-2.8-2.8v-3.5c0-1.5,1.2-2.8,2.8-2.8H240c1.5,0,2.8,1.2,2.8,2.8v3.5
                C242.7,124.1,241.5,125.3,240,125.3z" />
                      <rect x="25.5" y="167.3" className="st0" width={235} height="13.4" />
                    </g>
                    <g>
                ...
                c0-5.2,4.2-9.4,9.4-9.4h120.3c5.2,0,9.4,4.2,9.4,9.4V257.1z" />
                      <path className="st6" d="M36.7,210.6c0,3.1-2.5,5.6-5.6,5.6s-5.6-2.5-5.6-5.6c0-3.1,2.5-5.6,5.6-5.6S36.7,207.6,36.7,210.6z" />
                      <path className="st7" d="M53.2,210.6c0,3.1-2.5,5.6-5.6,5.6s-5.6-2.5-5.6-5.6c0-3.1,2.5-5.6,5.6-5.6S53.2,207.6,53.2,210.6z" />
                      <path className="st8" d="M69.8,210.6c0,3.1-2.5,5.6-5.6,5.6c-3.1,0-5.6-2.5-5.6-5.6c0-3.1,2.5-5.6,5.6-5.6
                C67.3,205.1,69.8,207.6,69.8,210.6z" />
                      <ellipse transform="matrix(0.9239 -0.3827 0.3827 0.9239 -60.7714 115.7734)" className="st7" cx="260.6" cy="210.6" rx="12.5" ry="12.5" />
                      <path className="st7" d="M240,215.1h-51.7c-1.5,0-2.8-1.2-2.8-2.8v-3.5c0-1.5,1.2-2.8,2.8-2.8H240c1.5,0,2.8,1.2,2.8,2.8v3.5
                C242.7,213.9,241.5,215.1,240,215.1z" />
                      <rect x="25.5" y="257.1" className="st0" width={235} height="13.4" />
                    </g>
                    <g>
                ...
                c0-5.2,4.2-9.4,9.4-9.4h120.3c5.2,0,9.4,4.2,9.4,9.4V346.9z" />
                      <circle className="st6" cx="31.1" cy="300.4" r="5.6" />
                      <circle className="st7" cx="47.6" cy="300.4" r="5.6" />
                      <circle className="st8" cx="64.2" cy="300.4" r="5.6" />
                      <circle className="st7" cx="260.6" cy="300.4" r="12.5" />
                      <path className="st7" d="M240,304.9h-51.7c-1.5,0-2.8-1.2-2.8-2.8v-3.5c0-1.5,1.2-2.8,2.8-2.8H240c1.5,0,2.8,1.2,2.8,2.8v3.5
                C242.7,303.7,241.5,304.9,240,304.9z" />
                      <rect x="25.5" y="346.9" className="st0" width={235} height="13.4" />
                    </g>
                    <g>
                ...
                c0-5.2,4.2-9.4,9.4-9.4h120.3c5.2,0,9.4,4.2,9.4,9.4V436.7z" />
                      <path className="st6" d="M36.7,390.2c0,3.1-2.5,5.6-5.6,5.6s-5.6-2.5-5.6-5.6c0-3.1,2.5-5.6,5.6-5.6S36.7,387.2,36.7,390.2z" />
                      <path className="st7" d="M53.2,390.2c0,3.1-2.5,5.6-5.6,5.6s-5.6-2.5-5.6-5.6c0-3.1,2.5-5.6,5.6-5.6S53.2,387.2,53.2,390.2z" />
                      <path className="st8" d="M69.8,390.2c0,3.1-2.5,5.6-5.6,5.6c-3.1,0-5.6-2.5-5.6-5.6c0-3.1,2.5-5.6,5.6-5.6
                C67.3,384.7,69.8,387.2,69.8,390.2z" />
                      <ellipse transform="matrix(0.9239 -0.3827 0.3827 0.9239 -129.5015 129.4447)" className="st7" cx="260.6" cy="390.2" rx="12.5" ry="12.5" />
                      <path className="st7" d="M240,394.7h-51.7c-1.5,0-2.8-1.2-2.8-2.8v-3.5c0-1.5,1.2-2.8,2.8-2.8H240c1.5,0,2.8,1.2,2.8,2.8v3.5
                C242.7,393.5,241.5,394.7,240,394.7z" />
                      <rect x="25.5" y="436.7" className="st0" width={235} height="13.4" />
                    </g>
                  </g>
                  <g>
              ...
              c-6,0-10.9-4.9-10.9-10.9v-35.4c0-6,4.9-10.9,10.9-10.9h35.4c6,0,10.9,4.9,10.9,10.9V297C456.1,303,451.2,307.9,445.2,307.9z" />
                    <ellipse transform="matrix(0.7071 -0.7071 0.7071 0.7071 -72.2681 384.0805)" className="st0" cx="427.5" cy="279.3" rx={21} ry={21} />
                    <g>
                      <path className="st16" d="M424.4,279.3c0,2.1-1.7,3.8-3.8,3.8c-2.1,0-3.8-1.7-3.8-3.8c0-2.1,1.7-3.8,3.8-3.8
                C422.7,275.5,424.4,277.2,424.4,279.3z" />
                      <path className="st16" d="M438.1,279.3c0,2.1-1.7,3.8-3.8,3.8c-2.1,0-3.8-1.7-3.8-3.8c0-2.1,1.7-3.8,3.8-3.8
                C436.4,275.5,438.1,277.2,438.1,279.3z" />
                    </g>
                  </g>
                  <g>
                    <g>
                      <path className="st17" d="M650,392.6c0,0-0.3,15,0,16.5c0.2,1.5-5.9,10.3-8.4,9.9c-2.5-0.4-7.5-1.2-8.2-2.1
                ...
                c-1.2-1.3-9.9-13.3-10.6-14.4c-0.7-1.1-1.2-3.7-1.2-5.2c0-1.5-1.4-4.9-3.9-5.7C648.2,406.6,642.7,406.9,640.3,408.2z" />
                      <path className="st17" d="M558.8,401.2c0,0,0,8.7-0.3,10.2c-0.2,1.5,5.9,10.3,8.4,9.9c2.5-0.4,7.5-1.2,8.2-2.1
                c0.7-0.8,0.4-2.8,0.1-4.6c-0.3-1.8-1.9-11.8-1.9-12.7C573.4,401.2,561.5,399,558.8,401.2z" />
                      <path className="st2" d="M566.8,208.8c-3.5,12.9-10.2,56.9-10.2,78.4c0,21.4-2.1,76-2.1,84.3c0,8.3-0.9,28.9,1.3,30
                ...
                C704.1,133.8,685.9,147.7,685.9,147.7z" />
                      <path className="st8" d="M585.4,62c-4.5-0.9-13.1-9.4-13.9-18c-0.8-8.4-6.9-31.9,14.5-40.7c20.1-8.3,40.8,0.2,43.8,10.5
                ...
                c0-2.5-13.8-8.4-19.4-8.2C591.8,41.5,585.3,41.7,585.1,45.3z" />
                      <path className="st23" d="M586,45.3c1.2,0-0.2,7,1.9,9.3C590,57,599.1,69,608.8,67.9c8.4-1,7.2-8.2,8.4-14.2
                ...
                C662,116.2,661.2,116.6,660.7,117.3z" />
                      <path className="st17" d="M705.2,131.6c-2.7,0.3-6.7,1.8-6.7,3.2c0,1.4,3.2,1.8,4.1,2c0.9,0.1,2,0.4,1.7,0.8c-0.3,0.4-1,2.6-2.8,2.3
          ...
          {/* Offline info */}
          <h5 className="mb-2 display-7 mt-5 text-center">Connect wallet to see this page</h5>
        </div>
      </div>
    </div>
  );
